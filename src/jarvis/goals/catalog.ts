...
export const DEFAULT_GOALS: GoalDefinition[] = [
  ...
  },
  {
    ...
    examples: ['What can you do?', 'What goals can you handle end to end?'],
    matchingHints: ['capabilities', 'what can you do', 'goals can you handle'],
    requiredInputs: [],
    optionalInputs: [],
    routes: [],
  ...
  },
  {
    ...
    scope: 'SELF_KNOWLEDGE',
    handler: 'SELF_KNOWLEDGE',
    examples: ["Why can't you do this?", 'What do you need from me?'],
    matchingHints: ['why unavailable', 'what do you need', 'capability gap'],
    requiredInputs: [],
    optionalInputs: [],
    routes: [],
