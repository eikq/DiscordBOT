...
const TYPE_TO_STATE: Partial<Record<JarvisOperationEventType, JarvisVisualState>> = {
  ...
  PERMISSION_DENIED: 'WAITING_PERMISSION',
  PLAN_CREATED: 'PLANNING',
  PLAN_UPDATED: 'PLANNING',
  PLAN_APPROVED: 'EXECUTING',
  PLAN_STAGE_STARTED: 'EXECUTING',
  PLAN_STAGE_COMPLETED: 'EXECUTING',
  PLAN_STAGE_FAILED: 'ERROR',
  ARTIFACT_CREATED: 'EXECUTING',
  ARTIFACT_UPDATED: 'EXECUTING',
  VERIFY_STARTED: 'VERIFYING',
  VERIFY_RESULT: 'VERIFYING',
  MEMORY_UPDATED: 'MEMORY_RETRIEVAL',
  MODEL_STATUS_CHANGED: 'MODEL_GENERATING',
