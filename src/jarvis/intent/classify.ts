...
const ACTION_CUES = /เปิด|เข้า|ปิด|เริ่ม|รีสตาร์ต|รีสตาร์ท|เตือน|จัดการ|แก้|ช่วยดู|ช่วยเปิด|ช่วยหา|ตั้งค่า|launch|open|start|stop|restart|remind|check|handle/iu;
