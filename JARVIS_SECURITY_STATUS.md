...
| EVO-001–010 | Evolution / affect / LoRA | IMPLEMENTED + UNIT_VERIFIED fail-closed runtime (no auto-promote, LoRA registry untrained, affect cannot authorize). Live night cycle **BLOCKED_LOCAL_ACCEPTANCE** |
